...
const Skils = () => {
  return (
    <div id="skills" className="w-screen h-full mt-20 mb-12 md:mt-0 md:h-screen">
      <Link
        href="https://www.linkedin.com/in/emanuel-lopez-developer/details/certifications/"
        className="max-w-[1100px] mx-2 md:mx-auto flex flex-col justify-center h-full shadow-base shadow-white group hover:bg-gradient-to-r ">
          ...
          <div className="grid grid-cols-2 gap-8 text-white cursor-pointer lg:grid-cols-4 ">
            ...
            <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105 hover:text-yellow-400">
              <div className="grid items-center justify-center grid-cols-2 gap-4">
                ...
                <div className="flex flex-col items-center justify-center px-9">
                  <h3 className="text-sm titulo-secundary text-md md:text-xl ">
                    JavaScript
                  </h3>
                </div>
              </div>
            ...
            <div className="p-6 duration-300 ease-in shadow-xl rounded-xl hover:scale-105 hover:text-blue-300 ">
              <div className="grid items-center justify-center grid-cols-2 gap-4">
                ...
                <div className="flex flex-col items-center justify-center">
                  <h3 className="titulo-secundary text-md md:text-xl ">
                    React
                  </h3>
                </div>
              </div>
